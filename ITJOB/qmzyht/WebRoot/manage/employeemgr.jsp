...
<html lang="zh">
	<head>
		...
		<script type="text/javascript">
			function updateemployee(eid,ename,epassword,eemail,esex,eimg,ephone,ebirth){
			...
			function deleteEmployee(eid){
				window.location.href = "m_deleteEmployee.action?eid="+eid;
			}
	...
	<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="box">
					<div class="box-header"><h2><i class="fa fa-github-alt"></i>个人用户</h2></div>
					<div class="box-content">
						<div class="row toolbar">
							<div class="col-xs-4">
								<form action="m_queryEmployee.action" method="post">
									<div class="input-group">
										<div class="input-group-btn">
											...
											<ul class="dropdown-menu" aria-labelledby="searchTypeOption">
												<li data-option="query_ename" ><a href="#">按 姓名</a></li>
												<li data-option="query_esex"><a href="#">按性别</a></li>
											</ul>
										</div><!-- /btn-group -->
						...
						<div class="table-responsive">
							<table class="table table-condensed table-bordered table-hover table-striped">
								...
								<tbody>
									<s:iterator value ="lst" id = "employee">
										<tr>
											<td><s:property value = "#employee.eid"/></td>
											<td><s:property value = "#employee.ename"/></td>
											<td><s:property value = "#employee.esex"/></td>
											<td><s:property value = "#employee.ebirth"/></td>
											<td><s:property value = "#employee.ephone"/></td>
											<td><s:property value = "#employee.email"/></td>
											
											<td>
											<%-- 	<button class="btn btn-info btn-xs" data-toggle="modal" data-target="#editModal" onclick="updateEmployee('<s:property value = "#employee.eid"/>','<s:property value = "#employee.ename"/>','<s:property value = "#employee.epassword"/>','
												<s:property value = "#employee.email"/>','
												<s:property value = "#employee.esex"/>','
												<s:property value = "#employee.ephone"/>','
												<s:property value = "#employee.eimg"/>
												">
								
												<i class="fa fa-edit"></i></button> --%>
												<button class="btn btn-danger btn-xs" onclick = "deleteEmployee('<s:property value = "#employee.eid"/>')">
						...
						<s:url id="url_pre" value="m_queryEmployee"><s:param name="currentPage" value="currentPage-1"></s:param></s:url>
						<s:url id="url_first" value="m_queryEmployee"><s:param name="currentPage" value="1"></s:param></s:url>
						<s:url id="url_last" value="m_queryEmployee"><s:param name="currentPage" value="totalPage"></s:param></s:url>
						<s:url id="url_next" value="m_queryEmployee"><s:param name="currentPage" value="currentPage+1"></s:param></s:url>
						<div class="clearfix">
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
        				<form role="form" action="m_editEmployee.action" enctype="multipart/form-data" method="post">
        					<div class="row">
        						<div class="col-lg-6">
