...
#mainPanel{
	...
	height:450px;
    border-radius: 18px;
    background-image: -moz-linear-gradient(top,#FFFAF0, #fff);
...
#wrapper{
	...
	overflow-x:hidden;
	overflow-y:hidden;
    background-image: -moz-linear-gradient(top,#a4c4f2, #fff);
...
;
	...
	<body>
			...
			<div id="heading">
				...
				<div id="subTitle">Ver 8.0</div>
				<img src="image/logoit.png" style="position: absolute; width: 181px; height: 84px;margin-top: -81px;margin-left: 43px;"/>
			</div>
		</div>
	...
	<div class="right">
					...
					<form method="post" action="m_login.action" class="form-horizontal login" onSubmit="check_login(this);">
									...
									<div class="form-horizontal-login"> <h2>管理员登录</h2></div>
