...
public class EmployeeDao {
	...
	//查询搜索职位表
	@SuppressWarnings("unchecked")
	public List<Companyjob> findCompanyjobs(String cjob){
		String hql="from Companyjob as companyjob where companyjob.cjob like '%"+cjob+"'";
		return getSession().createQuery(hql).list();
	}
	//查询薪酬范围
	@SuppressWarnings("unchecked")
	public List<Companyjob> findCsalary(){
		String hql="";
		return getSession().createQuery(hql).list();	
	}
	//分页按薪酬
