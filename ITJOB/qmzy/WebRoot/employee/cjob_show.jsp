...
<link rel="stylesheet" type="text/css" href="stylecjob_show.css">
...
<div class="search">
	...
	<div class="row toolbar">
							<div class="col-xs-7">
								<form action="cjobQuery.action" method="post">
									<div class="input-group">
										<div class="input-group-btn">
											...
											<ul class="dropdown-menu" aria-labelledby="searchTypeOption">
												<li data-option="query_cjob" ><a href="#">按职位</a></li>
												<li data-option="query_csalary" ><a href="#">按薪酬</a></li>
												<li data-option="query_cjaddress" ><a href="#">按区域</a></li>
											</ul>
										</div><!-- /btn-group -->
	...
	<div class="form-group">
			<div class="col-lg-4" style="z-index: 500">
				<label>区域</label>
			...
			<div class="show">
				<div class="table-responsive">
							...
							<thead>
					<tr class="active">
						<th style="width:160px;padding-left:50px">职位名称</th>
						<th style="width:400px;padding-left:180px">工作要求</th>
						<th style="width:100px">工作地点</th>
						<th style="width:70px">薪酬</th>
						...
						<tbody>
									<s:iterator value ="lst" id = "companyjob">
										<tr>										
											<td style="padding-left:30px"><s:property value = "#companyjob.cjob"/></td>
											<td><s:property value = "#companyjob.crequest"/></td>
											<td><s:property value = "#companyjob.cjaddress"/></td>
											<td style="padding-left:15px"><s:property value="#companyjob.csalary"/></td>
									        <td style="padding-left:15px"><s:property value="#companyjob.credate"/></td>
									        <td><a href="jianjie.jsp">详情</a></td>
										</tr>
									</s:iterator>
								</tbody>
...
<div>
<s:url id="url_pre" value="cjobQuery"><s:param name="currentPage" value="currentPage-1"></s:param></s:url>
						<s:url id="url_first" value="cjobQuery"><s:param name="currentPage" value="1"></s:param></s:url>
						<s:url id="url_last" value="cjobQuery"><s:param name="currentPage" value="totalPage"></s:param></s:url>
						<s:url id="url_next" value="cjobQuery"><s:param name="currentPage" value="currentPage+1"></s:param></s:url>
						<div class="clearfix">
							<ul class="pagination" >
...
<div class="ad">
<a href=""><img src="images/ad/ad5.jpg" style="width:200px;height:300px"/></a><br><br><br>
<a href=""><img src="images/ad/ad6.jpg"style="width:200px;height:300px"/></a>
</div>
<div class="ad2">
<a href=""><img src="images/ad/ad1.gif" style="width:200px;height:300px"/></a><br><br><br>
<a href=""><img src="images/ad/ad2.gif"style="width:200px;height:300px"/></a>
</div>
