	   ...
	   <div class="top">
	         <div class="W1003">
	         	            ...
	         	            <div class=" fr Reglogin">
	         	                 <ul>
	         	            	<li><a href="main.jsp"> ${ename}的主页！</a></li><!--注册-->
	         	            	<li>/</li>
...
<div class="logo">
			...
			<div class="headsearch" id="headsearch" action="###">
				...
				<a href="cjobQuery"><input type="submit" class="search-btn" value="搜索"></a>
			...
			<div class="headsearch--hot-text">
				热门搜索:
				<a href="cjobQuery" class="headsearch--hot-text-a">WEB前端</a>
				<a href="cjobQuery" class="headsearch--hot-text-a">Java</a>
...
<!--下面部分 -->
<div class="center-middle-bottom">
				...
				<div class="table-responsive">
					...
					<tr class="active">
					 ...
					 <tr  id="active">
						<td><a href="index.html">全容电子商务有限公司</a></td>
	...
	<div class="userinfo cf">
	        ...
	        <div class="name-wrap">
	            ...
	            <div class="operate cf">
	                ...
	                <a href="information" class="center-right-btn" >个人档案</a>
	                   <a href="main" class="center-right-btn" >设置</a>
	                <a href="main" class="center-right-btn" >我的收藏</a>
	                  <a href="main" class="center-right-btn" >我的动态</a>
