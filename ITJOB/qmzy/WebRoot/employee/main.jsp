...
<div class="container-fluid cfh_banner">
  <div class="container"> 
    <ul class="list-inline">
      <li><a href="total" target="_self">首页</a></li>
      <li><a href="list_page.html" target="_self">兼职信息</a></li>
      <li><a href="message_m" target="_self">动态</a></li>
      <li><a href="index" target="_self">退出</a></li>
    </ul>
  </div>
</div>
<!-- top + banner 结束 --> 
...
<div class="container border1 nopadding margin10">
  <div id="vertical_navigation" class="col-lg-3 background831312 nopadding" style="background:#a4c4f2">
    <div class="dead_pic"><img src="images/7.jpg"><br>
      <span class="username"><a href="information">wang</a></span></div>
