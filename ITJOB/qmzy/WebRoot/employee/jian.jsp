...
fieldset{
	...
	<body>
		 <input id="nowPage" type="hidden" value="job">
                ...
                <div class="base_info">
                 ...
                 <!--投递简历按钮-->
                <div class="btnJL submitJL" onClick="clickLog('from=chr_normdetail_deliver&jobid=163bb0e4f54f30578c3d3784j&gtid=40b8e36ae3174518ba097f0eb73baa86');"><a href="index.html">公司简介</a></div>
    ...
    公司旗下自主研发与运营的B2B电子商务平台——“品材汇”（pincai360.com），是以装饰建材为基础，以装饰要素为核心，以一流的技术和先进的管理为支撑，深度研发云计算，充分挖掘大数据，为上下游客户提供商业信息、宣传推广、研究咨询、网络营销、第三方认证、软件和技术支持等全流程服务。作为中国装饰与建材行业电子商务平台的领先者，品材汇致力于引领产业升级，打造行业纵深、区域纵深、服务纵深专业化全方位的价值链条，以极致的客户体验为基础，构建行业一流的生态商务系统。
    公司拥有一支技术能力强、专业素质过硬、营运管理水平高的人才队伍。目前团队成员中拥有超过20年传统装饰建材行业经验、超过15年的互联网企业管理经验、10余年B2B电子商务平台运营经验和资深的技术开发和设计经验等各种人才，这支配置一流、结构合理的管理人才对建材及相关行业B2B电商平台的业务技术发展历程、未来前景走向具有深刻的认识和理解，他们深度把脉行业发展趋势，依托“互联网+”创新驱动，带领公司健康、快速发展。
    我们通过DT技术改造来提升建材产业水平，为建材行业的快速发展进行一场互联网技术的革命。我们无比珍惜“互联网+”时代赋予的机遇，定将通过高效运作，卓越管理，携手我们的客户及合作伙伴创造跨界、融合、共生的产业环境，帮助中国装饰与建材行业上下游企业构建交流渠道，建立联系、挖掘国内市场商业机会，打造装饰与建材行业“阳光生态圈”。
...
<fieldset>
	...
	<textarea cols="45" rows="7" id="message" name="exp" required="required" placeholder="在此填写你的个人经历."></textarea>
	</p>
	<p>
	<label for="message">自我介绍:</label>
	<textarea cols="45" rows="7" id="message" name="information" required="required" placeholder="在此填写你的自我介绍."></textarea>
	</p>
