         ...
         <div class="top">
	         <div class="W1003">
	         	            <div class="FL saoma">
	         	            	...
	         	            	<a href="c_index" target="_">进入企业版</a>
	         	            </div>
	         	            <div class=" fr Reglogin">
	         	                 <ul>
	         	            	<li><a href="login_l">注册</a></li><!--注册-->
	         	            	<li>/</li>
...
<!--账号 -->
     <form class="form-horizontal" method="post" action="mlogin" >

<div class="form-group">
<label for="inputEmail3" class="col-sm-3 control-label"><span>用户名：</span></label>
<div class="col-sm-7">
<input type="text" class="form-control" id="inputEmail3" placeholder="username" name="ename">
</div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-3 control-label"><span>密码：</span></label>
<div class="col-sm-7">
<input type="password" name="epassword" class="form-control" id="inputPassword3 password" placeholder="Password">
</div>
</div>
